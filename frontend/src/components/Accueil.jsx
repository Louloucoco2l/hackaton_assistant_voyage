...
import FloatingChatBot from './FloatingChatBot'; // ✅ import du chatbot
...
export default function Accueil() {
  return (
    <>
      ...
      <main
  id="homeScreen"
  className="flex-grow-1 d-flex flex-column align-items-center justify-content-center text-center px-3 py-5 accueil-hero"
...
>
        ...
        <div className="d-flex flex-column flex-sm-row gap-3">
            <a href="#plan" className="btn btn-primary px-4 py-2 text-decoration-none">Commencer à planifier</a>
            <a href="#about" className="btn btn-outline-secondary px-4 py-2 text-decoration-none">En savoir plus</a>
        </div>


          <a href="#features" className="mt-5 fs-3 text-secondary text-decoration-none" style={{ animation: 'bounce 2s infinite', cursor: 'pointer' }}>
            ⌄
          </a>
      ...
      <section className="py-5  " style={{ minHeight: '90vh' }} id="features">
